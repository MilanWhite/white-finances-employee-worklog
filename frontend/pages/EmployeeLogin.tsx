        ...
        <div className="flex min-h-full flex-1">
          <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div className="mx-auto w-full max-w-sm lg:w-96">
              <div>
                <LogoText/>
                <h2 className="mt-8 text-2xl/9 font-bold tracking-tight text-dark">Employee Sign In</h2>
                <p className="mt-2 text-sm/6 text-light">
                  Not an employee?{' '}
                  <a href="#" className="font-semibold text-slate-blue hover:text-slate-blue-hover">
                  ...
                  <form action="#" method="POST" className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex gap-3">
                        ...
                        <label htmlFor="remember-me" className="block text-sm/6 text-dark">
                          Remember me
                        </label>
                      </div>
